...
class Application(tk.Frame):
    ...
    # -------- メインフレームのオブジェクトの作成 --------
        ...
        #グラフを表示するボタン
        button_graph_1 = tk.Button(fm_main, text="IT Graph", **BUTTON_OPTIONS, font=("Arial", 12), width=8, command=self.create_fm_graph_1)
        button_graph_1.grid(row=7, column=0, columnspan=2, padx=20, pady=20, sticky=tk.E)
        
        button_graph_2 = tk.Button(fm_main, text="IV Graph", **BUTTON_OPTIONS, font=("Arial", 12), width=8, command=self.create_fm_graph_2)
